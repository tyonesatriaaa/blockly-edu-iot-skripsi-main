...
export default function Workspace() {
    ...
    const initialXml =
        '<xml xmlns="http://www.w3.org/1999/xhtml"><block type="iot_devboard" x="70" y="30"><statement name="device"><block type="variables_set"><field name="VAR" id="]^ts@{#`U-J4$)K~_}!.">j</field><value name="VALUE"><block type="variables_gets"><field name="pilihan_sensor">suhu</field></block></value><next><block type="controls_for"><field name="VAR" id="m:?eq*)`(r$R`p`;N?c`">i</field><value name="FROM"><block type="math_number"><field name="NUM">1</field></block></value><value name="TO"><block type="variables_get"><field name="VAR" id="]^ts@{#`U-J4$)K~_}!.">j</field></block></value><statement name="DO"><block type="text_print"><value name="TEXT"><block type="variables_get"><field name="VAR" id="m:?eq*)`(r$R`p`;N?c`">i</field></block></value></block></statement></block></next></block></statement></block></xml>';
