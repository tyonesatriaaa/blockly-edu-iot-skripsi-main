...
export default function Workspace() {
    ...
    const initialXml =
    '<xml xmlns="http://www.w3.org/1999/xhtml"><block type="iot_devboard" x="70" y="30"><value name="device"><block type="text_print"><value name="TEXT"><block type="text"><field name="TEXT">Test 123</field></block></value></block></value></block></xml>';
