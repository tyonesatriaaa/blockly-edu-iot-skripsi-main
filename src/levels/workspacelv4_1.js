...
export default function Workspace() {
    ...
    const initialXml =
        '<xml xmlns="http://www.w3.org/1999/xhtml"><block type="iot_devboard" x="70" y="30"> <statement name="device"> <block type="text_print"> <value name="TEXT"><block type="procedures_callreturn"><mutation name="do something"><arg name="x"></arg><arg name="y"></arg></mutation><value name="ARG0"> <block type="math_number"> <field name="NUM">3</field> </block> </value> <value name="ARG1"> <block type="math_number"> <field name="NUM">4</field></block></value></block></value></block></statement></block><block type="procedures_defreturn" x="70" y="200"><mutation><arg name="x" varid="xadI^[T9/rd,Ks(5u)fL"></arg><arg name="y" varid="a^GCfF8D1lMIBNrsJN5@"></arg> </mutation><field name="NAME">do something</field><comment pinned="false" h="80" w="160">Describe this function...</comment> <value name="RETURN"><block type="math_arithmetic"><field name="OP">ADD</field><value name="A"> <block type="variables_get"> <field name="VAR" id="xadI^[T9/rd,Ks(5u)fL">x</field></block> </value> <value name="B"> <block type="variables_get"><field name="VAR" id="a^GCfF8D1lMIBNrsJN5@">y</field> </block> </value> </block> </value></block></xml>';
            ...
            <div style={{ backgroundColor: "#471D8C", padding: "2%" }}>
                ...
                <div style={{ width: "100%", position: "relative" }}>
                    ...
                    >
                        {/* start levels */}
                        <div>
                            <p className="level text-white">Example Level 4</p>
