...
export default function Workspace() {
    ...
    const initialXml =
        '<xml xmlns="http://www.w3.org/1999/xhtml"><block type="iot_devboard" x="70" y="30"><statement name="device"><block type="controls_if"><value name="IF0"><block type="sensor"><field name="pilihan_sensor">suhu</field><field name="pilihan_operator">==</field><field name="value_sensor">27</field></block></value><statement name="DO0"><block type="aktuator_fan"><field name="value">500</field></block></statement></block></statement></block></xml>';
