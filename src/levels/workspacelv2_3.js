...
export default function Workspace() {
    ...
    const initialXml =
        '<xml xmlns="http://www.w3.org/1999/xhtml"><block type="iot_devboard" x="70" y="30"><statement name="device"><block type="variables_set"><field name="VAR" id="*Edvd+C_odcs#b?~5X4A">a</field><value name="VALUE"><block type="variables_gets"><field name="pilihan_sensor">suhu</field></block></value><next><block type="variables_set"><field name="VAR" id="+uC!?)rkq{{]XGmo[B,l">b</field><value name="VALUE"><block type="variables_gets"><field name="pilihan_sensor">kelembapan</field></block></value><next><block type="controls_if"><mutation else="1"></mutation><value name="IF0"><block type="logic_compare"><field name="OP">GT</field><value name="A"><block type="variables_get"><field name="VAR" id="*Edvd+C_odcs#b?~5X4A">a</field></block></value><value name="B"><block type="variables_get"><field name="VAR" id="+uC!?)rkq{{]XGmo[B,l">b</field></block></value></block></value><statement name="DO0"><block type="text_print"><value name="TEXT"><block type="text"><field name="TEXT">Dingin Kering</field></block></value></block></statement><statement name="ELSE"><block type="text_print"><value name="TEXT"><block type="text"><field name="TEXT">Dingin Lembab</field></block></value></block></statement></block></next></block></next></block></statement></block>d</xml>';
            ...
            <div style={{ backgroundColor: "#471D8C", padding: "2%" }}>
                ...
                <div style={{ width: "100%", position: "relative" }}>
                    ...
                    >
                        {/* start levels */}
                        <div>
                            <p className="level text-white">Example Level 2</p>
