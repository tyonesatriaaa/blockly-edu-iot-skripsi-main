...
export default function Workspace() {
    ...
    const initialXml =
        '<xml xmlns="http://www.w3.org/1999/xhtml"><block type="iot_devboard" x="70" y="30"><statement name="device"><block type="variables_set"><field name="VAR" id="X1ri!E$GOz]j46~sUE:p">hitung</field> <value name="VALUE"><block type="math_number"> <field name="NUM">1</field> </block> </value><next><block type="controls_whileUntil"><field name="MODE">WHILE</field><value name="BOOL"><block type="logic_compare"><field name="OP">LTE</field><value name="A"><block type="variables_get"><field name="VAR" id="X1ri!E$GOz]j46~sUE:p">hitung</field></block> </value> <value name="B"><block type="math_number"><field name="NUM">3</field></block></value></block></value><statement name="DO"><block type="text_print"><value name="TEXT"> <block type="text"> <field name="TEXT">Muncul 3 Kali</field></block></value><next><block type="variables_set"><field name="VAR" id="X1ri!E$GOz]j46~sUE:p">hitung</field>=<value name="VALUE">= <block type="math_arithmetic">=<field name="OP">ADD</field>=<value name="A">=<block type="variables_get"><field name="VAR" id="X1ri!E$GOz]j46~sUE:p">hitung</field></block></value><value name="B"><block type="math_number"><field name="NUM">1</field></block></value></block></value></block></next></block></statement></block></next></block></statement></block></xml>';
