...
export default function Workspace() {
    ...
    const initialXml =
        '<xml xmlns="http://www.w3.org/1999/xhtml"><block type="iot_devboard" x="70" y="30"><statement name="device"><block type="controls_if"><mutation else="1"></mutation><value name="IF0"><block type="sensor"><field name="pilihan_sensor">cahaya</field><field name="pilihan_operator">&lt;</field><field name="value_sensor">10</field></block></value><statement name="DO0"><block type="text_print"><value name="TEXT"><block type="text"><field name="TEXT">Redup</field></block></value></block></statement><statement name="ELSE"><block type="text_print"><value name="TEXT"><block type="text"><field name="TEXT">Terang</field></block></value></block></statement></block></statement>\]</block></xml>';
