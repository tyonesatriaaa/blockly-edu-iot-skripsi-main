...
export default function Workspace() {
    ...
    const initialXml =
        '<xml xmlns="http://www.w3.org/1999/xhtml"><block type="iot_devboard" x="70" y="30"> <statement name="device"><block type="procedures_callnoreturn"><mutation name="Menyalakan_Buzzer"></mutation></block></statement></block><block type="procedures_defnoreturn" x="70" y="150"><field name="NAME">Menyalakan_Buzzer</field><comment pinned="false" h="80" w="160">Describe this function...</comment><statement name="STACK"> <block type="controls_if"> <value name="IF0"><block type="sensor"><field name="pilihan_sensor">suhu</field> <field name="pilihan_operator">&gt;</field><field name="value_sensor">28</field></block></value><statement name="DO0"><block type="aktuator_buzzer_on"><field name="kondisi">ON</field> </block> </statement>    </block> </statement></block></xml>';
